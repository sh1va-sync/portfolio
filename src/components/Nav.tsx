...
export function Nav() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`nav-logo-shell${isLogoExpanded ? ' is-expanded' : ''}`}
        ...
        {isOpen && (
          <motion.div
            ...
            style={{
              ...
              minHeight: '100dvh',
              padding:
                'clamp(96px, 13vh, 132px) clamp(24px, 8vw, 120px) 24px',
              background:
                'linear-gradient(135deg, #07112f 0%, #172e78 52%, #2563eb 100%)',
              color: '#fff',
              overflow: 'auto',
            }}
          >
